...
import org.pircbotx.twitch.DynamicCommandHandler;
...
public class Configuration {
    ...
    protected final DynamicCommandHandler dynamicCommandHandler;
    ...
    protected Configuration(Builder builder) {
        ...
        this.dynamicCommandHandler = builder.getDynamicCommandHandler();
    }
    ...
    public static class Builder {
        ...
        protected DynamicCommandHandler dynamicCommandHandler = new DynamicCommandHandler();
        ...
        public Builder(Configuration configuration) {
            ...
            this.dynamicCommandHandler = configuration.getDynamicCommandHandler();
        }
        ...
        public Builder(Builder otherBuilder) {
            ...
            this.dynamicCommandHandler = otherBuilder.getDynamicCommandHandler();
        }
        ...
        public Configuration.Builder addTwitchSupport() {
            addListener(new ListenerAdapter() {
                ...
                public void onConnect(ConnectEvent event) throws Exception {
                    ...
                    event.getBot().sendRaw().rawLine("CAP REQ :twitch.tv/commands");
                }
            });
            return this;
        }
