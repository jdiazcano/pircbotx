 ...
 */
@ToString
public class UserStateConfig extends PrivMsgConfig {
    ...
    public UserStateConfig(String message, List<String> parsedLine, ImmutableMap<String, String> tags, String line) {
